...
$toolManifestFilePath = Join-Path $rootPath .config dotnet-tools.json;
$testProjectFilePath = Join-Path $rootPath __PROJECT_NAME__.Test __PROJECT_NAME__.Test.csproj;
